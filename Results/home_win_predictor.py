...
for league in leagues:
    ...
    output_folder = f"home_Leagues_all/{league[0]}_{league[1]}"
    ...
    for i in range(0, runs):
        ...
        train_data = train_data.drop(columns=['Date', 'home_win', 'League', 'Country'])
        test_data = data_filtered[data_filtered['Date'] > cut_off_date]
        y_test = test_data["home_win"]
        test_data = test_data.drop(columns=['Date', 'home_win', 'League', 'Country'])
