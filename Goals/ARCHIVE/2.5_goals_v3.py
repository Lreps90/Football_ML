...
for encoding in encodings:
    try:
        data = pd.read_csv("GOAL_DATA_2.CSV", encoding=encoding)
...
param_grid = [
    ...
    {
        'model': [MLPClassifier()],
        'model__hidden_layer_sizes': [(100,), (50, 50), (100, 50), (100, 100), (250), (500)],
        ...
        try:
            ...
            for threshold in thresholds:
                ...
                if total_stake > 500:
                    ...
                    t_stat, p_value_two_tailed = ttest_1samp(profit_list, 0)
            ...
            if results:
                ...
                output_file = os.path.join(output_folder, f"results_{rd.randint(1,100000)}.txt")
